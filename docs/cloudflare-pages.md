...
| 運用チェック（Dashboard・案内） | **完了**（2026-07-21） | §8.2 A–D / §8.4 |
...
### 8.4 運用締めチェックシート（人が記入）

コピーして Discord / Notion 等で管理してよい。コードリポジトリ上の進捗メモ用。

| # | 確認項目 | 状態 (Yes/No/N/A) | 確認日 | メモ |
|---|----------|-------------------|--------|------|
| A1 | Supabase Redirect に `https://fctzs.daruji.workers.dev/` がある | Yes | 2026-07-21 | 運用者確認 |
| A2 | 新 URL で Discord Login → ログイン状態で戻る | Yes | 2026-07-21 | |
| B1 | Home / Sessions / Character / Recruit / Schedule が開く | Yes | 2026-07-21 | |
| B2 | キャラ・シナリオ画像が R2 から表示される | Yes | 2026-07-21 | |
| C1 | GitHub Pages Source = None（または意図的に残置） | Yes | 2026-07-21 | |
| C2 | 旧 github.io Redirect を整理した（任意） | Yes | 2026-07-21 | |
| C3 | Discord・ブックマークの案内が新 URL | Yes | 2026-07-21 | |
| D1 | 通知リンクが新 URL ドメイン（任意） | Yes | 2026-07-21 | |

関連: Flutter 限定公開は [`flutter-web-deploy.md`](./flutter-web-deploy.md)。  
セキュリティ四半期テストは [`security-smoke-log.md`](./security-smoke-log.md)。
