...
window.PATCH_NOTES = Object.freeze([
  ...
  },
  {
    ...
    detail: "募集人数の10人上限を撤廃し、下限〜上限表示・応募締切・先着/抽選を選べるようにしました。1ヶ月ごとの自動削除はやめ、期限切れは締め切りのみ行います。抽選募集は締切後に応募が上限を超えている場合、募集主が抽選できます。"
  },
  {
    date: "2026-08-30",
    type: "feature",
    title: "感想の閲覧をシナリオ通過者にも拡大",
    detail: "部内の卓参加・キャラ通過履歴に加え、部活外通過シナリオ（タイトルまたはシナリオID一致）があれば、同シナリオの感想を読めるようにしました。"
  },
  {
    date: "2026-08-30",
    type: "feature",
    title: "卓・シナリオの感想投稿を追加",
    detail: "卓詳細・シナリオ詳細に感想欄を追加しました。閲覧はシナリオ通過者（および自分が書いた投稿）に限定され、ネタバレは既定で隠します。シナリオ詳細では卓なし（部活外など）でも投稿できます。公開コメントとは別です。"
  },
  {
    date: "2026-08-09",
    type: "fix",
  ...
  },
  {
    ...
    type: "feature",
    title: "プレイヤー自己連携",
    detail: "ホームの未連携案内から、自分のプレイヤー名を選んで Discord アカウントと名簿を紐付けできるようにしました。"
  },
  {
    date: "2026-07-22",
    type: "improvement",
  ...
  },
  {
    ...
    detail: "キャラクター新規作成の外部データインポートで、従来のテキスト貼り付けに加え、.txtファイルのアップロードからも反映できるようにしました。"
  },
  {
    date: "2026-07-21",
    type: "feature",
    title: "Web操作まわりのUI改善",
    detail: "操作結果をtoast表示に統一し、スケジュールの副操作を折りたたみ、プレイヤー未連携時の案内バナー、プレイヤー名簿カード＋検索、詳細画面の「次にやること」導線を追加しました。ボタン／検索パネルの見た目も揃えました。"
  },
  {
    date: "2026-07-21",
    type: "fix",
    title: "卓参加者の表示とキャラ並びを修正",
    detail: "配列列削除後に卓の参加者・参加キャラが空になり、キャラ一覧の並びが崩れていた問題を修正しました（junctionをService Roleで読む）。スケジュールは「卓名 / セッション名」表示にしました。"
  },
  {
    date: "2026-07-21",
    type: "improvement",
    title: "キャラ並びとスケジュール表示を修正",
    detail: "キャラクター一覧の直近セッション順ソート（日時パース含む）を直し、スケジュールカレンダーの表示をセッション名ではなく卓タイトル優先に戻しました。"
  },
  {
    date: "2026-07-21",
    type: "improvement",
